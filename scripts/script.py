...
#     img = np.fromstring(fig.canvas.renderer.buffer_rgba(), dtype='uint8').reshape(int(height), int(width), 3)
#     return img

def lineplot(ax, x, y, linecolor, linewidth, linestyle):
    ax.plot(x, y, linecolor, linewidth, linestyle)